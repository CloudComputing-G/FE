...
- **모바일 화면 전용**: 이 프로젝트는 **모바일 웹 화면만** 구현합니다. PC/데스크톱 화면은 추구 구현할 계획입니다.
- **고정 너비 기준**: 모바일 뷰포트(약 375px~430px) 기준으로 작업하며, `sm:`, `md:`, `lg:`, `xl:` 같은 데스크톱용 브레이크포인트는 사용하지 않습니다.
- **브라우저 지원**: 모바일 Chrome, Safari(iOS) 기준으로 작성합니다.
...
- [ ] 모바일 뷰포트(375~430px)에서 정상 동작하는가?
- [ ] 주요 브라우저(Chrome, Safari, Edge, Firefox)에서 정상 렌더링되는가?
